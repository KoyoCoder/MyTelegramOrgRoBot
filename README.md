...
- can be found on [Telegram](https://telegram.dog/TgOrgRobot)

🙄 [@TgOrgRobot](https://telegram.dog/TgOrgRobot) **is the only Telegram RoBot, which is using this repository code**. 🙄😬
...
```sh
git clone https://GitHub.com/Starkbug/MyTelegramOrgRoBot.git
```
...
- Please report any issues to the support group: [@Bots](https://t.me/StarkBugBots)
