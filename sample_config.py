...
class Config:
    ...
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "TgOrgRobot")
    ...
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Starkbugbots")
    ...
    ORIGINAL_CODE = "aHR0cHM6Ly9naXRodWIuY29tL1N0YXJrQnVnL015VGVsZWdyYW1PcmdSb0JvdC9yYXcvbWFzdGVyL2JvdC5weQ=="
